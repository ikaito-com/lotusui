...
var downloadTargets = []downloadTarget{
	{osKey: "macos", label: "Download for macOS", note: "macOS — universal .app (Apple Silicon and Intel)", asset: "lotusui-docsapp-macos-universal.zip"},
	{osKey: "windows", label: "Download for Windows", note: "Windows — x64", asset: "lotusui-docsapp-windows-amd64.zip"},
	{osKey: "linux", label: "Download for Linux", note: "Linux — x64", asset: "lotusui-docsapp-linux-amd64.tar.gz"},
}
